...
// We'll use framer-motion for animations. 
// No need to install anything, it will work in this environment.
...
function ContactPage() {
  ...
  useEffect(() => {
    // Only run if the container ref exists and leaflet script has loaded
    if (mapContainerRef.current && leafletLoaded) {
      ...
      // Add the tile layer (map background) from OpenStreetMap
      ...
      const customMarkerIcon = window.L.divIcon({
        ...
        className: '', // We use Tailwind classes in the HTML
        iconSize: [32, 42],
        iconAnchor: [16, 42],
        popupAnchor: [0, -42]
      });
  ...
  }, [leafletLoaded]); // This effect depends on leafletLoaded state
        ...
        <div className="container mx-auto px-4 py-16 sm:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
            ...
            >
              ...
              >
                ...
                <motion.div variants={itemVariants} className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    {/* Mapping over the contractors array to display them dynamically */}
              ...
              {/* Interactive Map in its original place */}
              <motion.div 
                className="h-64 bg-gray-200 rounded-lg mt-8 overflow-hidden"
