    ...
    <>
      ...
      <div className="w-full form-container">
        ...
        <form className="space-y-6">
          ...
          {/* Forgot Links */}
          <div className="text-sm text-center flex justify-center gap-6 pt-2 form-element">
              <a href="#" className="font-medium text-black hover:text-neutral-700 transition-colors duration-300">
                  Forgot Password?
              </a>
              <a href="#" className="font-medium text-black hover:text-neutral-700 transition-colors duration-300">
                  Forgot Username?
